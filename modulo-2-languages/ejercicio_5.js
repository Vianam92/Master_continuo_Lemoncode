...
El usuario habrá ganado en caso de que los tres booleanos sean true, y por tanto deberá mostrarse
...
class SlothMachine {
  ...
  play() {
    ...
    do {
      ...
      index++;
      if (index) this.results.push(number);
    } while (index < 3)
    const randomBoleans = (current) => current % 2 === 0;
      let resultRandom = this.results.every(randomBoleans);
